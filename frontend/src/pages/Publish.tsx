...
export const Publish = () => {
    ...
    }} id="Title" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 " placeholder="Title"></textarea>
    <div className="mt-8">
   ...
   }} type="submit" className="mt-4 bg-black inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white rounded-lg focus:ring-4 ">
       Publish post
   </button>
        </div>
...
<form>
   <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50">
       <div className="flex items-center justify-between px-3 py-2 border-b">
           ...
           <div id="tooltip-fullscreen" role="tooltip" className="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300  rounded-lg shadow-sm opacity-0 tooltip ">
               Show full screen
       ...
       <div className="px-4 py-2 bg-white rounded-b-lg">
           ...
           <textarea onChange={onChange} id="editor" className="focus:outline-none block w-full px-0 text-sm text-gray-800 bg-white border-0  focus:ring-0 " placeholder="Write an article..." required ></textarea>
       </div>
   </div>
